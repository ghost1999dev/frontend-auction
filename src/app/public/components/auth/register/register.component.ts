...
export class RegisterComponent {
  ...
  displayRequirementsDialog: boolean = false;
  requirementsMessage = `
    ...
    <p>Estos campos serán requeridos después del inicio de sesión para acceder a todas las funcionalidades.</p>
  `;
  ...
  selectUserType(userType: "developer" | "company") {
    if (userType === "company") {
      this.displayRequirementsDialog = true;
    } else {
